export const general = {
  ...
  about: {
    ...
    icons: "Icons",
    iconsDescription: "Interface and Chat file icons come from these projects",
    iconUse: {
      interface: "Interface icons",
      chatFiles: "Chat file icons",
    },
    lucideLicense: "ISC; Feather-derived icons are MIT",
    vscodeIconsLicense: "CC BY-SA for icons; branded icons retain separate rights",
    lucideAuthor: "Lucide contributors",
    vscodeIconsAuthor: "vscode-icons contributors",
    file: "File",
    source: "Source",
    author: "Author",
    soundUse: {
