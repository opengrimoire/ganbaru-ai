...
/**
 * Normalize a hex input into the canonical "#RRGGBB" form. Accepts both
 * 3- and 6-digit hex with or without a leading #. Returns null when the
...
/** Convert a 6-digit hex string to RGB components. Returns null on bad input. */
