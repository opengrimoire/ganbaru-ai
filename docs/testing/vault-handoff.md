...
1. Open desktop Data settings, show the pairing QR code, choose `Link to desktop` during fresh Android setup, grant camera access, and scan once. Confirm the camera stops and both devices show the linked relationship without entering an address.
