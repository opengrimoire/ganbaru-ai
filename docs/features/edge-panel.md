...
| Section | Purpose |
|---------|---------|
| Quick-access icons | Calendar, Kanban, Notes, Music, Settings. One click switches to that module. |
...
| Quick-add task | Single text field; types a title and presses Enter to create a kanban task in the current project. |
...
- **Kanban:** the linked tasks populate the checkbox list.
