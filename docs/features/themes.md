...
- **Calendar details**: UI description: "Semantic markers and accents on the calendar grid"; a sourceless group that collects the calendar details a user can reasonably tune: today marker (pair), now line, break marker, and focus marker.
