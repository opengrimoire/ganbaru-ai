...
Text and actions renders the same way after its landmark. Ink, Primary action, Destructive, Confirm, and Warning keep their own source and row logic, but they are stacked together with thin internal dividers.
