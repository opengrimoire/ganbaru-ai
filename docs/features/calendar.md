...
Past read-only event panels keep editing controls locked, but the Meeting section can still expand for inspection. Opening it does not enable edits or emit a change.
