...
- App shell layout: compact, even edge spacing around the tabs and primary workspace, persisted right-click visibility controls for hideable title bar sections and compact tab labels, and a help modal listing available keyboard shortcuts.
