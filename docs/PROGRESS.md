...
- App shell layout: compact, even edge spacing around the tabs and primary workspace, plus persisted right-click visibility controls for hideable title bar sections and compact tab labels.
