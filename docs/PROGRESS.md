...
- Record the first v9 benchmark run after adding closed-process startup cooldowns, then compare memory and latency against canonical baseline `2026-05-04-03`.
